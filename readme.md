# RevISA - **Rev**isão **I**nteligente de **S**ubmissões **A**cadêmicas

> Fork de pesquisa do projeto **DeepReview / CycleResearcher** (ICLR 2025 / ACL 2025), adaptado para a tese de mestrado *"Agentes de IA na Avaliação Científica: Uma Revisão Automatizada de Publicações em Periódicos Brasileiros"*. O pacote Python foi renomeado de `ai_researcher` para `revisa`.
...
from revisa import CycleResearcher
from revisa.utils import print_paper_summary
...
```python
# Import necessary libraries
from revisa import CycleReviewer
